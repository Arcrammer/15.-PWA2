        ...
        "success": function (fetchUsersResponse) {
            if (fetchUsersResponse.error) {
                ...
                for (var userIndex=0;userIndex < fetchUsersResponse.users.length;userIndex++) {
                    ...
                    var userListElement = '<li class="userListItem" id="' + userAtCurrentIndex["id"] + '">';
                    userListElement += '<p class="userName">' + userAtCurrentIndex["first_name"] + '</p>';
                    userListElement += '<p class="userHandle">@' + userAtCurrentIndex["user_n"] + '</p></li>';
